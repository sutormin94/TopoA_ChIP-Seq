...
#List of filenames.
Filename_list=["EcTopoI_noCTD_noRif_rep346_nm_0.001_peaks_motifs_1", "EcTopoI_noCTD_noRif_rep346_nm_0.001_peaks_motifs_2", "EcTopoI_noCTD_noRif_rep346_nm_0.001_peaks_motifs_3"]



def read_convert(datapath, filename_list):
...
read_convert(Data_path, Filename_list)