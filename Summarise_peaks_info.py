...
PWD_peaks="C:\Sutor\Science\E_coli_RNA-Seq\Expression_data\DY330_genes\\"
#Input: Intervals (e.g. EcTopoI peaks) (tab-delimited with headers).
path_to_intervals_sets={'Operons exp phase'    : [PWD_peaks + "DY330_RNA-Seq_genes_EP_del_cor.txt", 'Genes_EP_expression_and_all_info'],
                        }
...
path_to_cont_data={'HNS Kahramanoglou'   : PWD_wig + "Kahramanoglou_HNS_IP_ME.wig",
                   ...
                   'DRIP-Seq fw Sutormin'   : "C:\Sutor\Science\E_coli_DRIP-Seq\Data_analysis\Strand_average_scaled\DRIP_Seq_CTD_minus_Rif_minus_forward_av.wig",
                   'DRIP-Seq rv Sutormin'   : "C:\Sutor\Science\E_coli_DRIP-Seq\Data_analysis\Strand_average_scaled\DRIP_Seq_CTD_minus_Rif_minus_reverse_av.wig",
                   }

#Output: path to the dir to store output
Outputpath="C:\Sutor\Science\E_coli_ChIP-Seqs\Data_for_ORFs\\"
